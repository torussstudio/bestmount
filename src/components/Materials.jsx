...
// // Inject/refresh at module level. IMPORTANT: we always overwrite textContent
// // (not just create-once) so Vite HMR picks up CSS edits without a full
// // page reload — a stale <style> tag from a previous version otherwise
// // silently keeps old rules in effect.
...
//                     {/* Grid header */}
//                      <div className="hidden md:flex items-center justify-between mb-3 mt-4 ml-2 pl-0 md:pl-0">
...
const CARD_STYLES = `
  ...
  .card-image-wrap {
    width: 100%;
    height: clamp(100px, 32cqw, 180px);
    flex-shrink: 0;
    display: flex;
    align-items: center;
    justify-content: center;
