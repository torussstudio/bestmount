...
// /** Inject line-mask CSS exactly once */
...
//  * Falls back immediately if the API is unavailable.
//  */
// const fontsReady = () =>
...
//   const targets = [titleSplit.lines, paraSplit.lines, buttonRef.current];
...
//         ease: EASES.ui, duration: 0.7 },
//       "-=0.42",
//     )

//     .call(() => gsap.set(targets, { willChange: "auto" }));

//   return {
//     tl,
//     cleanup: () => { tl.kill(); titleSplit.revert(); paraSplit.revert(); },
//   };
// }
...
//     /* Wait for fonts before splitting text — eliminates the
//        "SplitText called before fonts loaded" console warnings */
//     fontsReady().then(() => {
//       ctx = gsap.context(() => {
