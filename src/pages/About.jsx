...
export default function About() {
  ...
  useEffect(() => {
    ...
    sections.forEach(s=>{
      ...
      if(s.trigger.current){

        observer.observe(s.trigger.current);
